...
class Day2Test {
    ...
    fun minMaxDiff() {
        val input = "5 1 9 5\n7 5 3\n2 4 6 8"
        Assert.assertEquals(18, Day2.part1Solution(input))
    }
    @Test
    fun wholeDivSum() {
        val input = "5 9 2 8\n" +
                "9 4 7 3\n" +
                "3 8 6 5"
        Assert.assertEquals(9, Day2.part2Solution(input))
    }

    @Test
    fun myInput() {
        val input = "278\t1689\t250\t1512\t1792\t1974\t175\t1639\t235\t1635\t1690\t1947\t810\t224\t928\t859\n" +
        ...
        Assert.assertEquals(42378, Day2.part1Solution(input))
    }
    ...
    fun realInputPart2() {
        val input = "278\t1689\t250\t1512\t1792\t1974\t175\t1639\t235\t1635\t1690\t1947\t810\t224\t928\t859\n" +
                ...
                "149\t4140\t112\t3748\t148\t815\t4261\t138\t1422\t2670\t32\t334\t2029\t4750\t4472\t2010\n" +
                "114\t605\t94\t136\t96\t167\t553\t395\t164\t159\t284\t104\t530\t551\t544\t18\n"
        Assert.assertEquals(246, Day2.part2Solution(input))
    }
}